          ...
          <section id="workexperienceID" className="jobs">
            ...
            <div className="job">
              ...
              <div className="jobInfo">
                ...
                kundeservice.(På grunn av bedriftens kritiske økonomiske
            ...
            <div className="job">
              ...
              <div className="jobInfo">
                ...
                tekster fra engelsk og dansk til norsk. (Største kunde gikk
            ...
            <div className="job">
              ...
              <div className="jobInfo">
                ...
                oppstod. (Byttet arbeidsplass da jeg ble tilbudt stilling hos
                New Nordic).
              </div>
              <div className="program-container">
                <button className="programButton">Office</button>
            ...
            <div className="job">
              ...
              <div className="jobInfo">
                ...
                mediehusene og direkte med annonsør.
              </div>
              <div className="program-container">
                <button className="programButton">Indesign</button>
                <button className="programButton">Photoshop</button>
            ...
            <div className="job">
              ...
              <div className="jobInfo">
                ...
                tillegg til stillingen satt jeg også i resepsjonen.
              </div>
              <div className="program-container">
                <button className="programButton">Indesign</button>
                <button className="programButton">Photoshop</button>
            ...
            <div className="job">
              ...
              <div className="jobInfo">
                {" "}
                Ansatt som overkonduktør. Arbeidsoppgavene bestod av salg,
                sikkerhet, kundeveiledning, service og håndtering av vanskelige
                kundesituasjoner.
              </div>
            </div>
            ...
            <div className="job">
              ...
              <div className="jobInfo">
                {" "}
                Ansatt som assistent. Arbeidsoppgaver var kundebehandling og
                salg av produkter. Laget også reklamemateriell.
              </div>
              <div className="program-container">
                <button className="programButton">Indesign</button>
                <button className="programButton">Photoshop</button>
            ...
            <div className="job">
              ...
              <div className="jobInfo">
                {" "}
                Ansatt som operatør (Vikariat). Arbeidet med grønnsaker ved
                synebånd, hvor vi renset ut dårlig varer.
              </div>
            </div>
              ...
              <div className="summerJob">
                ...
                <div className="summerJob">
                  ...
                  <div className="summerjob-wrapper-text">
                    ...
                    <div className="summerjob-wrapper-text-inside">
                      <div className="jobNameSummerjob">Gilde</div>
                      <div className="jobInfoSummerjob">
                        Pakking og prising.
                      </div>
                    </div>
                    <div className="summerjob-wrapper-text-inside">
            ...
            <section id="educationID" className="education">
              ...
              <div className="myeducation">
                ...
                <div className="InfoEducation">
                  Innhold i studie: Geografi, salg, kundesikkerhet,
                  trafikksikkerhet, personlig sikkerhet.
                </div>
              </div>
              ...
              <div className="myeducation">
                ...
                <div className="InfoEducation">
                  ...
                  funksjon i et interaktivt medium oppbygning av nettsted.
                </div>
                <div className="program-container">
              ...
              <div className="myeducation">
                ...
                <div className="InfoEducation">Linje: Almen påbygning.</div>
              </div>
              ...
              <div className="myeducation">
                ...
                <div className="InfoEducation">
                  Linje: Tegne, form og farge. Spesialisering: Avansert tegning
                  og maling. Kunst, akt og perspektiv.
                </div>
              </div>
            </section>
            ...
            <section id="courseexperienceID" className="courses">
              ...
              <div className="mycourse">
                ...
                <div className="Infocourse">
                  ...
                  nettsider og apper. Designe nettsider med hjelp av Figma.
                </div>
                <div className="program-container">
                  <button className="programButton">HTML</button>
                  <button className="programButton">CSS</button>
              ...
              <div className="mycourse">
                ...
                <div className="Infocourse">
                  Linkedin Learning. Triks for å gi design og illustrasjoner mer
                  dybde, volum og gjennomsiktighet.
                </div>
                <div className="program-container">
                  <button className="programButton">Linkedin</button>
                  <button className="programButton">Photoshop</button>
